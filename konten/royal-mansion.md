# Royal Mansion — halaman proyek selesai

> **Cara pakai:** koreksi isi file ini dulu. Yang bertanda `[CEK]` belum saya
> ketahui — jangan dibiarkan, karena saya tidak akan mengarang. Kalau sudah fix,
> bilang saja, baru saya jadikan halaman HTML di `/royal-mansion/`.
>
> Sekarang `/royal-mansion/` **404**, padahal dicari 204 kali/bulan di Google
> dengan **nol klik**. Ini yang paling rugi dari semua temuan SEO kemarin.
...
Ini bagian terpenting di file ini.

Royal Mansion **205 unit**, tapi yang terdokumentasi foto serah terimanya hanya
**20 — semuanya dari cluster akhir, tipe Adiluhung.** Artinya foto kita mewakili
di bawah 10% proyek, dan hanya fase paling akhirnya.

Kalau halaman ini menampilkan galeri tanpa penjelasan, pembaca akan menyangka
Royal Mansion itu proyek kecil berisi 20 rumah — justru mengecilkan pencapaian
yang sebenarnya besar.

Tiga cara menanganinya, pilih satu:

- **A. Sebutkan apa adanya.** Tulis "205 unit" sebagai fakta, lalu jelaskan
  bahwa dokumentasi foto baru rutin dilakukan sejak cluster Adiluhung.
  Jujur, dan justru memperlihatkan bahwa kebiasaan mendokumentasi itu tumbuh.
  ← **saran saya**
- **B. Halaman fokus ke cluster Adiluhung saja.** Judulnya jadi
  "Royal Mansion — Cluster Adiluhung". Aman, tapi menyia-nyiakan angka 205.
...
## 2. Bagian atas halaman (hero)

**Judul:** Royal Mansion

**Kalimat pembuka** — versi untuk pilihan **A**:

> 205 rumah dibangun, dan seluruhnya kini dihuni. Cluster terakhirnya, Adiluhung,
> adalah yang pertama kami dokumentasikan hari demi hari.

Versi untuk pilihan **B**:

> Cluster Adiluhung, penutup Royal Mansion. Rumah dua lantai bergaya klasik,
> seluruhnya sudah diserahterimakan.
...
Silakan ubah. Kalimat terakhir sengaja saya buat mengakui bahwa dokumentasi lama
tidak selengkap sekarang; itu lebih kuat daripada berpura-pura.

---

## 4. Galeri serah terima

20 foto cluster Adiluhung, diambil otomatis dari arsip yang sudah ada.
Tampil 5–6 di halaman, sisanya lewat tautan ke `/serah-terima/`.
...
## 5. Ajakan di bagian bawah

> **Mencari rumah dua lantai seperti ini?** Tipe Andrawina di Tentrem Bhumi
> punya karakter yang paling mendekati.
...
## 6. Untuk mesin pencari

**Title** (maks ±60 karakter):

> Royal Mansion — Perumahan JGS yang Sudah Selesai & Dihuni
...
Catatan: ada akun Instagram lama **@graharoyalmansion**. Kalau masih dipegang
tim, arahkan bio-nya ke halaman ini setelah terbit.

---

## 7. Catatan desain (bukan untuk diisi)

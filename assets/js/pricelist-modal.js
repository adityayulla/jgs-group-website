    ...
    '<div id="pricelist-overlay" style="display:none;" onclick="if(event.target===this)window.closePricelistModal()">' +
      '<div id="pricelist-modal">' +
        ...
        '<div id="pricelist-modal-body">' +
          '<div class="pm-head">' +
            '<img class="pm-avatar" src="/assets/img/marketing-dwi.jpg" alt="Dwi — tim marketing JGS Group" width="54" height="54">' +
            '<div class="pm-head-txt">' +
              '<h3 class="pm-title">Download Pricelist</h3>' +
              '<p class="pm-agent">Dibalas langsung oleh <b>Dwi</b>, tim kami 👋</p>' +
            '</div>' +
          '</div>' +
          ...
          '<div id="pricelist-form">' +
            ...
            '<a id="pl-wa" href="https://wa.me/6288902929571?text=Halo%20Dwi%2C%20saya%20ingin%20minta%20pricelist%20lengkap%20JGS.%20(via%20web)" target="_blank" rel="noopener">' +

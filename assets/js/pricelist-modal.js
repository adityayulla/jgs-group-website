...
(function () {
  ...
  style.textContent =
    ...
    '.pm-head { display: flex; align-items: center; gap: 12px; margin-bottom: 18px; text-align: left; }' +
    ...
    '.pm-privacy { font-size: 11.5px; color: #aaa; margin: 8px 0 0; text-align: center; }' +
    '.pm-nocall {' +
    ...
    '  .pm-privacy { font-size: 11px; margin-top: 7px; }' +
      ...
      '<div id="pricelist-modal">' +
        ...
        '<div id="pricelist-modal-body">' +
          '<div class="pm-head">' +
            ...
            '</div>' +
          '</div>' +
          /* 24 Sep 2026: versi ringkas. Clarity 30 hari (HP): popup dibuka ±420×, ✕ 165×, kirim 64× —
             rasio tutup:kirim 2,6. Kalimat pengantar + 3 bullet manfaat dibuang; yang tersisa dua kolom,
             satu tombol, tautan WA. Ukur ulang rasio ✕:kirim ±8 Okt 2026. */
